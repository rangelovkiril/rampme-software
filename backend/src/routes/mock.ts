...
import { getMockBusStatus, getMockBusEntity, MOCK_BUS_ID } from '../services/mock-bus'
...
export const mockRoutes = new Elysia({ prefix: '/mock' })
  ...
  .get(
    ...
    { detail: { tags: ['Mock'], summary: 'Vehicle ID of the mock bus (use this for ramp reservations)' } },
  )
