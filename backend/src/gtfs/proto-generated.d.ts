...
export function encodeFeedMessage(message: FeedMessage): Uint8Array {
  let bb = popByteBuffer();
  _encodeFeedMessage(message, bb);
  return toUint8Array(bb);
}

function _encodeFeedMessage(message: FeedMessage, bb: ByteBuffer): void {
...
export function decodeFeedMessage(binary: Uint8Array): FeedMessage {
  return _decodeFeedMessage(wrapByteBuffer(binary));
}

function _decodeFeedMessage(bb: ByteBuffer): FeedMessage {
  let message: FeedMessage = {} as any;
...
export function encodeFeedHeader(message: FeedHeader): Uint8Array {
  let bb = popByteBuffer();
  _encodeFeedHeader(message, bb);
  return toUint8Array(bb);
}

function _encodeFeedHeader(message: FeedHeader, bb: ByteBuffer): void {
...
export function decodeFeedHeader(binary: Uint8Array): FeedHeader {
  return _decodeFeedHeader(wrapByteBuffer(binary));
}

function _decodeFeedHeader(bb: ByteBuffer): FeedHeader {
  let message: FeedHeader = {} as any;
...
export function encodeFeedEntity(message: FeedEntity): Uint8Array {
  let bb = popByteBuffer();
  _encodeFeedEntity(message, bb);
  return toUint8Array(bb);
}

function _encodeFeedEntity(message: FeedEntity, bb: ByteBuffer): void {
...
export function decodeFeedEntity(binary: Uint8Array): FeedEntity {
  return _decodeFeedEntity(wrapByteBuffer(binary));
}

function _decodeFeedEntity(bb: ByteBuffer): FeedEntity {
  let message: FeedEntity = {} as any;
...
export function encodeTripUpdate(message: TripUpdate): Uint8Array {
  let bb = popByteBuffer();
  _encodeTripUpdate(message, bb);
  return toUint8Array(bb);
}

function _encodeTripUpdate(message: TripUpdate, bb: ByteBuffer): void {
...
export function decodeTripUpdate(binary: Uint8Array): TripUpdate {
  return _decodeTripUpdate(wrapByteBuffer(binary));
}

function _decodeTripUpdate(bb: ByteBuffer): TripUpdate {
  let message: TripUpdate = {} as any;
...
export function encodeStopTimeEvent(message: StopTimeEvent): Uint8Array {
  let bb = popByteBuffer();
  _encodeStopTimeEvent(message, bb);
  return toUint8Array(bb);
}

function _encodeStopTimeEvent(message: StopTimeEvent, bb: ByteBuffer): void {
...
export function decodeStopTimeEvent(binary: Uint8Array): StopTimeEvent {
  return _decodeStopTimeEvent(wrapByteBuffer(binary));
}

function _decodeStopTimeEvent(bb: ByteBuffer): StopTimeEvent {
  let message: StopTimeEvent = {} as any;
...
export function encodeVehiclePosition(message: VehiclePosition): Uint8Array {
  let bb = popByteBuffer();
  _encodeVehiclePosition(message, bb);
  return toUint8Array(bb);
}

function _encodeVehiclePosition(message: VehiclePosition, bb: ByteBuffer): void {
  // optional TripDescriptor trip = 1;
  let $trip = message.trip;
  if ($trip !== undefined) {
    writeVarint32(bb, 10);
...
export function decodeVehiclePosition(binary: Uint8Array): VehiclePosition {
  return _decodeVehiclePosition(wrapByteBuffer(binary));
}

function _decodeVehiclePosition(bb: ByteBuffer): VehiclePosition {
  let message: VehiclePosition = {} as any;
...
export function encodePosition(message: Position): Uint8Array {
  let bb = popByteBuffer();
  _encodePosition(message, bb);
  return toUint8Array(bb);
}

function _encodePosition(message: Position, bb: ByteBuffer): void {
...
export function decodePosition(binary: Uint8Array): Position {
  return _decodePosition(wrapByteBuffer(binary));
}

function _decodePosition(bb: ByteBuffer): Position {
  let message: Position = {} as any;
...
export function encodeAlert(message: Alert): Uint8Array {
  let bb = popByteBuffer();
  _encodeAlert(message, bb);
  return toUint8Array(bb);
}

function _encodeAlert(message: Alert, bb: ByteBuffer): void {
...
export function decodeAlert(binary: Uint8Array): Alert {
  return _decodeAlert(wrapByteBuffer(binary));
}

function _decodeAlert(bb: ByteBuffer): Alert {
  let message: Alert = {} as any;
...
export function encodeTimeRange(message: TimeRange): Uint8Array {
  let bb = popByteBuffer();
  _encodeTimeRange(message, bb);
  return toUint8Array(bb);
}

function _encodeTimeRange(message: TimeRange, bb: ByteBuffer): void {
...
export function decodeTimeRange(binary: Uint8Array): TimeRange {
  return _decodeTimeRange(wrapByteBuffer(binary));
}

function _decodeTimeRange(bb: ByteBuffer): TimeRange {
  let message: TimeRange = {} as any;
...
export function encodeEntitySelector(message: EntitySelector): Uint8Array {
  let bb = popByteBuffer();
  _encodeEntitySelector(message, bb);
  return toUint8Array(bb);
}

function _encodeEntitySelector(message: EntitySelector, bb: ByteBuffer): void {
...
export function decodeEntitySelector(binary: Uint8Array): EntitySelector {
  return _decodeEntitySelector(wrapByteBuffer(binary));
}

function _decodeEntitySelector(bb: ByteBuffer): EntitySelector {
  let message: EntitySelector = {} as any;
...
export function encodeTripDescriptor(message: TripDescriptor): Uint8Array {
  let bb = popByteBuffer();
  _encodeTripDescriptor(message, bb);
  return toUint8Array(bb);
}

function _encodeTripDescriptor(message: TripDescriptor, bb: ByteBuffer): void {
...
export function decodeTripDescriptor(binary: Uint8Array): TripDescriptor {
  return _decodeTripDescriptor(wrapByteBuffer(binary));
}

function _decodeTripDescriptor(bb: ByteBuffer): TripDescriptor {
  let message: TripDescriptor = {} as any;
...
export function encodeVehicleDescriptor(message: VehicleDescriptor): Uint8Array {
  let bb = popByteBuffer();
  _encodeVehicleDescriptor(message, bb);
  return toUint8Array(bb);
}

function _encodeVehicleDescriptor(message: VehicleDescriptor, bb: ByteBuffer): void {
...
export function decodeVehicleDescriptor(binary: Uint8Array): VehicleDescriptor {
  return _decodeVehicleDescriptor(wrapByteBuffer(binary));
}

function _decodeVehicleDescriptor(bb: ByteBuffer): VehicleDescriptor {
  let message: VehicleDescriptor = {} as any;
...
export function encodeTranslatedString(message: TranslatedString): Uint8Array {
  let bb = popByteBuffer();
  _encodeTranslatedString(message, bb);
  return toUint8Array(bb);
}

function _encodeTranslatedString(message: TranslatedString, bb: ByteBuffer): void {
...
export function decodeTranslatedString(binary: Uint8Array): TranslatedString {
  return _decodeTranslatedString(wrapByteBuffer(binary));
}

function _decodeTranslatedString(bb: ByteBuffer): TranslatedString {
  let message: TranslatedString = {} as any;
