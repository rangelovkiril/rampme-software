...
scripts/
  refresh-accessibility.ts     Crawls trinmo.org's fleet registry to rebuild the vehicle accessibility dataset; run weekly by .github/workflows/refresh-accessibility.yaml, never from the request path
