...
export default function SidePanel({
  ...
  return (
    <aside
      className={`side-panel-shell fixed top-0 bottom-0 left-0 z-[850] flex flex-col overflow-x-hidden backdrop-blur-xl max-sm:top-[var(--nav-bottom,72px)] max-sm:bottom-0 max-sm:inset-x-2 max-sm:rounded-2xl max-sm:shadow-[var(--shadow-lg)] max-sm:overflow-y-hidden ${
