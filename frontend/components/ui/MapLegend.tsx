...
export default function MapLegend() {
  return (
    <fieldset
      className="pointer-events-none fixed right-3 bottom-40 z-[600] rounded-xl border px-2.5 py-2 shadow-[var(--shadow)] sm:bottom-8 sm:left-4 sm:right-auto sm:px-3 sm:py-2.5"
